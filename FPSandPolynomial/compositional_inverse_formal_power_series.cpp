//
// FPS の逆関数 (Compositional Inverse) (Kinoshita-Li 法, O(N (log N)^2))
//
// verified:
...
// Library Checker - Compositional Inverse of Formal Power Series (Large)
void Yosupo_Compositional_inverse_of_formal_power_series() {
    ...
    auto res = compositional_inverse(a);
...
int main() {
    Yosupo_Compositional_inverse_of_formal_power_series();
}