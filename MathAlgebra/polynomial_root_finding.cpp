//
// 多項式の零点を求める (mod 998244353), O(N(log N)^2 + N log N log p + n(log n)^2 log p)
//
// verified:
//   Yosupo Library Checker - Polynomial Root Finding (Mod 998244353)
...
// Yosupo Library Checker - Polynomial Root Finding (Mod 998244353)
void Yosupo_Polynomial_Root_Finding() {
    ...
    auto res = find_polynomial_roots(f);
...
int main() {
    Yosupo_Polynomial_Root_Finding();
}