//
// Multipoint Evaluation in general, O(N(log N)^2)
//
// verified:
//   Yosupo Library Checker - Multipoint Evaluation
...
// Yosupo Library Checker - Multipoint Evaluation
void Yosupo_Multipoint_Evaluation() {
    ...
    for (int i = 0; i < M; i++) Read(p[i].val);
    auto res = multipoint_eval(f, p);
